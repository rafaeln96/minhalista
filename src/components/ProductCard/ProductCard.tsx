...
export function ProductCard({ product, onEdit, onRemove }: ProductCardProps) {
  ...
  const formattedQuantity = language === 'pt'
      ...
      <div className={styles.card}>
        ...
        <div className={styles.content}>
          <div className={styles.header}>
            ...
            <span className={styles.totalPrice}>{formatCurrency(totalPrice, language)}</span>
          </div>
          ...
          <div className={styles.footerRow}>
            <div className={styles.quantityControl}>
              <button type="button" className={styles.qtyBtn} onClick={handleDecrease}>−</button>
              <span className={styles.qtyValue}>{formattedQuantity}</span>
              <button type="button" className={styles.qtyBtn} onClick={handleIncrease}>+</button>
            </div>

            <div className={styles.actions}>
              <button type="button" className={styles.editBtn} onClick={onEdit} aria-label={t('product.editLabel')}>
                <svg width="16" height="16" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round">
                  <path d="M11 4H4a2 2 0 0 0-2 2v14a2 2 0 0 0 2 2h14a2 2 0 0 0 2-2v-7"></path>
                  <path d="M18.5 2.5a2.121 2.121 0 0 1 3 3L12 15l-4 1 1-4 9.5-9.5z"></path>
                </svg>
              </button>
              <button type="button" className={styles.deleteBtn} onClick={onRemove} aria-label={t('product.deleteLabel')}>
                <svg width="16" height="16" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round">
